...
public class ShoppingCartTests {
        ...
        public void itemNameTooLong() {
                Throwable exception = assertThrows(IllegalArgumentException.class,
                                () -> Store.addItem(CUSTOMER_ID,
                                                "0123456789 0123456789 0123456789 0123456789 0123456789", 99));
        ...
        public void cannotRemoveMoreItemsThanInCart() {
                ...
                assertEquals("Quantity exceeds the quantity of the item in the cart. You have 1.",
                                exception.getMessage());
        }
